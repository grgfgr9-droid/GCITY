...
MySQL.ready(function()
	local result = {{name = "property_black_money", label = "Argent Sale Propriété", shared = 0}}
...
AddEventHandler('addonaccount:getAccount', function(name, owner, cb)
	cb(GetAccount(name, owner))
end)

AddEventHandler('addonaccount:getSharedAccount', function(name, cb)
