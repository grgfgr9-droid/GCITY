    ...
    while true do
        ...
        if not uiFaded then
            ...
            if isInFrontend ~= inFrontend then
                ...
                SendNUIMessage({action = 'hideUi', value = inFrontend})
            end
        end
    end
end)
local display = false
  ...
  RegisterNetEvent('nui:serviceon')
  AddEventHandler('nui:serviceon', function()
    SendNUIMessage({
      type = "uiservice",
      display = true
    })
  ...
  RegisterNetEvent('nui:serviceoff')
  AddEventHandler('nui:serviceoff', function()
    SendNUIMessage({
      type = "uiservice",
      display = false
    })
